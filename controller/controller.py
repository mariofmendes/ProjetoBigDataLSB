from model.model import ModeloLSB #importa a classe ModeloLSB do módulo model.model
from view.view import VisualizacaoLSB #importa a classe VisualizacaoLSB do módulo view.view

class ControladorLSB:
    #Essa classe serve como ponte entre o modelo de dados e a visualização

    def __init__(self, caminho_dados: str): #recebe o caminho_dados na forma de string
        #Inicializa modelo e view
        self.modelo = ModeloLSB(caminho_dados) #instancia ModeloLSB e guarda em self.modelo
    ...
    def executar(self, ano, metrica: str, liga_selecionada: str = "Todas") -> None:
        ...
        df_ano = self.modelo.obter_dados_por_ano(ano) #chama o metodo obter_dados_por_ano do ModeloLSB passando o ano
